...
public class Route {
    ...
    private ArrayList<Polyline> route = new ArrayList<>();
    ...
    public void drawRoute(GoogleMap map, Context c, LatLng source, LatLng dest, String language, int pathColor)
    {
        mMap = map;
        context = c;
    ...
    private void drawPath(String  result, boolean withSteps) {
        ...
        try {
            ...
            if(pathColor == -1)
                ...
                drawnColor = context.getResources().getColor(pathColor);
            ...
            for(int z = 0; z<list.size()-1;z++){
                ...
                Polyline line = mMap.addPolyline(new PolylineOptions()
                        ...
                        .width(4)
                        .color(drawnColor).geodesic(true));
                route.add(line);
            }
